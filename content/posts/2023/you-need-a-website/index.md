...
Buying a domain is pretty easy. You just go to a registrar. Pick an available domain you like. Fill out the paperwork. Pay, and you're done. That domain is now your's, for one year. Don't worry, your registrar will auto renew the domain for you.
...
The Self host-able version, is free. You just need to host it yourself. A good and cheep way to do this, is by using [Linode](https://linode.com)'s nanode server plan. The nanode only costs $5/month. Linode also has a Wordpress install script. Just fill out the form, and boom, Wordpress!
...
[Wordpress Selfhost](https://wordpress.org)
